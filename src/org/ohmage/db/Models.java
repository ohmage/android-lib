...
public class Models {
    ...
    public static class DbModel {
         ...
         * This is called by
         * {@link DbProvider#delete(android.net.Uri, String, String[])}
         */
    ...
    public final static class Campaign extends DbModel {
         ...
         * 
         * @param cursor a cursor containing the fields specified in the
         *            Campaign schema, which is closed when this method returns.
        ...
        public static List<Campaign> fromCursor(Cursor cursor) {
            ...
            for (int i = 0; i < cursor.getCount(); i++) {
                ...
                c.mDescription = cursor.getString(cursor
                        .getColumnIndex(Campaigns.CAMPAIGN_DESCRIPTION));
                c.mCreationTimestamp = cursor.getString(cursor
                        .getColumnIndex(Campaigns.CAMPAIGN_CREATED));
                c.mDownloadTimestamp = cursor.getString(cursor
                        .getColumnIndex(Campaigns.CAMPAIGN_DOWNLOADED));
                c.mXml = cursor.getString(cursor
                        .getColumnIndex(Campaigns.CAMPAIGN_CONFIGURATION_XML));
                ...
                c.updated = cursor
                        .getLong(cursor.getColumnIndexOrThrow(Campaigns.CAMPAIGN_UPDATED));
                campaigns.add(c);
        ...
        public static Intent launchTriggerIntent(Context context, String campaignUrn) {
            ...
            Cursor surveys = context.getContentResolver().query(
                    Campaigns.buildSurveysUri(campaignUrn), null, null, null, null);
            ...
            return TriggerFramework.launchTriggersIntent(context, campaignUrn,
                    surveyTitles.toArray(new String[surveyTitles.size()]));
        }

        /**
         * Returns the uri of the first ready campaign in the db which should be
         * the campaign used in single campaign mode
         * 
         * @param context
         * @return the urn of the first ready campaign from the db, or null
         */
        public static String getSingleCampaign(Context context) {
            Cursor campaign = context.getContentResolver().query(Campaigns.CONTENT_URI,
                    new String[] {
                        Campaigns.CAMPAIGN_URN
                    }, Campaigns.CAMPAIGN_STATUS + "=" + Campaign.STATUS_READY, null,
                    Campaigns.CAMPAIGN_CREATED + " DESC");
        ...
        /**
         * Returns the first campaign in the db which should be the campaign
         * used in single campaign mode.
         * 
         * @param context
         * @return the first campaign from the db, or null
         */
        public static Campaign getFirstAvaliableCampaign(Context context) {
            Cursor campaign = context.getContentResolver().query(
                    Campaigns.CONTENT_URI,
                    new String[] {
                            Campaigns.CAMPAIGN_URN, Campaigns.CAMPAIGN_STATUS
                    },
                    Campaigns.CAMPAIGN_STATUS + "=" + Campaign.STATUS_REMOTE + " OR "
                            + Campaigns.CAMPAIGN_STATUS + "=" + Campaign.STATUS_READY + " OR "
                            + Campaigns.CAMPAIGN_STATUS + "=" + Campaign.STATUS_OUT_OF_DATE, null,
                    Campaigns.CAMPAIGN_CREATED + " DESC");
            Campaign c = null;
            if (campaign.moveToFirst()) {
                c = new Campaign();
        ...
        /**
         * Sets the campaign to {@link Campaign#STATUS_REMOTE}. Also removes
        ...
        private static void setRemote(Context context, SelectionBuilder builder) {
            ...
            if (campaigns.size() > 0) {
                ...
                context.getContentResolver().update(Campaigns.CONTENT_URI, cv,
                        builder.getSelection(), builder.getSelectionArgs());

                // Delete responses
                context.getContentResolver().delete(Responses.CONTENT_URI, builder.getSelection(),
        ...
        public void cleanUp(Context context) {
            ...
            SingleChoiceCustomDbAdapter customSingleChoices = new SingleChoiceCustomDbAdapter(
                    context);
         ...
         * @throws IOException
         */
        public static InputStream loadCampaignXml(Context context, String campaignUrn)
                throws IOException {
            ContentResolver cr = context.getContentResolver();
            Cursor cursor = cr.query(Campaigns.buildCampaignUri(campaignUrn), new String[] {
        ...
        private static int localResponseCount(Context context, Uri uri) {
            Cursor localResponses = context.getContentResolver().query(
                    uri,
                    new String[] {
                        Responses._ID
                    },
                    Responses.RESPONSE_STATUS + "!=" + Response.STATUS_DOWNLOADED + " AND "
                            + Responses.RESPONSE_STATUS + "!=" + Response.STATUS_UPLOADED, null,
                    null);
        ...
        /**
         * Returns the time of the last downloaded response for this campaign.
         * We should be able to sync all responses newer than it
         * 
        ...
        public long getLastDownloadedResponseTime(Context context) {
            Cursor c = context.getContentResolver().query(
                    ...
                    Responses.RESPONSE_STATUS + "=" + Response.STATUS_DOWNLOADED + " AND "
                            + Qualified.RESPONSES_CAMPAIGN_URN + "=?", new String[] {
                        mUrn
    ...
    public final static class Survey extends DbModel {
         ...
         * 
         * @param cursor a cursor containing the fields specified in the Survey
         *            schema, which is closed when this method returns.
        ...
        public static List<Survey> fromCursor(Cursor cursor) {
            ...
            for (int i = 0; i < cursor.getCount(); i++) {
                ...
                s.mDescription = cursor
                        .getString(cursor.getColumnIndex(Surveys.SURVEY_DESCRIPTION));
                ...
                s.mAnytime = cursor.getInt(cursor.getColumnIndex(Surveys.SURVEY_ANYTIME)) == 0 ? false
                        : true;
        ...
        /**
         * Launch the Trigger list for the campaign to which this survey belongs
         * with a list of surveys selected by default.
         * 
         * @param context
         * @param campaignUrn the campaign URN from which to read the list of
         *            surveys that will be selectable from the list
         * @param selectedSurveys an array of surveys which will be preselected
        ...
        public static Intent launchTriggerIntent(Context context, String campaignUrn,
            ...
            return TriggerFramework.launchTriggersIntent(context, campaignUrn,
                    surveyTitles.toArray(new String[surveyTitles.size()]), selectedSurveys);
        }
    }
    ...
    public final static class SurveyPrompt extends DbModel {
        ...
        public static List<SurveyPrompt> fromCursor(Cursor cursor) {
            ...
            for (int i = 0; i < cursor.getCount(); i++) {
                ...
                temp.mCompositeID = cursor.getString(cursor
                        .getColumnIndex(SurveyPrompts.COMPOSITE_ID));
                temp.mPromptID = cursor.getString(cursor.getColumnIndex(SurveyPrompts.PROMPT_ID));
                temp.mPromptText = cursor.getString(cursor
                        .getColumnIndex(SurveyPrompts.SURVEY_PROMPT_TEXT));
                temp.mPromptType = cursor.getString(cursor
                        .getColumnIndex(SurveyPrompts.SURVEY_PROMPT_TYPE));
                temp.mProperties = cursor.getString(cursor
                        .getColumnIndex(SurveyPrompts.SURVEY_PROMPT_PROPERTIES));
    ...
    public final static class Response extends DbModel {
         ...
         * 
         * @param cursor a cursor containing the fields specified in the
         *            Response schema, which is closed when this method returns.
        ...
        public static List<Response> fromCursor(Cursor cursor) {
            ...
            for (int i = 0; i < cursor.getCount(); i++) {
                ...
                if (!r.locationStatus.equals(SurveyGeotagService.LOCATION_UNAVAILABLE)) {
                    ...
                    r.locationLongitude = cursor.getDouble(cursor
                            .getColumnIndex(Responses.RESPONSE_LOCATION_LONGITUDE));
                    r.locationProvider = cursor.getString(cursor
                            .getColumnIndex(Responses.RESPONSE_LOCATION_PROVIDER));
                    r.locationAccuracy = cursor.getFloat(cursor
                            .getColumnIndex(Responses.RESPONSE_LOCATION_ACCURACY));
                    r.locationTime = cursor.getLong(cursor
    ...
    public final static class PromptResponse extends DbModel {
         ...
         * 
         * @param cursor a cursor containing the fields specified in the
         *            PromptResponse schema, which is closed when this method
         *            returns.
        ...
        public static List<PromptResponse> fromCursor(Cursor cursor) {
            ...
            for (int i = 0; i < cursor.getCount(); i++) {
                ...
                temp.mResponseID = cursor.getLong(cursor
                        .getColumnIndex(PromptResponses.RESPONSE_ID));
                temp.mCompositeID = cursor.getString(cursor
                        .getColumnIndex(PromptResponses.COMPOSITE_ID));
                temp.mPromptID = cursor.getString(cursor.getColumnIndex(PromptResponses.PROMPT_ID));
                temp.mValue = cursor.getString(cursor
                        .getColumnIndex(PromptResponses.PROMPT_RESPONSE_VALUE));
                temp.mExtraValue = cursor.getString(cursor
                        .getColumnIndex(PromptResponses.PROMPT_RESPONSE_EXTRA_VALUE));
                prompts.add(temp);
