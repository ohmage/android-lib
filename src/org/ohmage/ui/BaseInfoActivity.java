 ...
 * and provides a view below the header that scrolls independently.
 * 
 * @author faisal
 */
public abstract class BaseInfoActivity extends BaseSingleFragmentActivity {
    ...
    private View initLayout() {
        LinearLayout baseLayout = (LinearLayout) getLayoutInflater().inflate(
                R.layout.base_info_activity, null);
    ...
    protected void setDetailsExpansionHandler(View parent, final View child) {
        parent.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                child.setVisibility((currentVis == View.INVISIBLE || currentVis == View.GONE) ? View.VISIBLE
                        : View.GONE);
            }
        });
    }
