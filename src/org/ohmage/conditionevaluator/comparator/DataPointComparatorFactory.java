...
/**
 * Creates a DataPointComparator based on the prompt type. The possible prompt
 * types are defined in the DataPoint.PromptType enum. Each prompt type must
 * have a comparator defined by extending the AbstractDataPointComparator class.
 * 
 * @author mmonibi
 */
public final class DataPointComparatorFactory {
     ...
     * 
     * @param promptType One of the prompt types defined by the
     *            DataPoint.PromptType enum
