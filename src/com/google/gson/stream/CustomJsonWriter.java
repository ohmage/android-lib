 ...
 * @since 1.6
 */
public class CustomJsonWriter implements Closeable {
   ...
   * bracket.
   */
  private CustomJsonWriter open(JsonScope empty, String openBracket) throws IOException {
    beforeValue(true);
    stack.add(empty);
   ...
   * given bracket.
   */
  private CustomJsonWriter close(JsonScope empty, JsonScope nonempty, String closeBracket)
      throws IOException {
...
//      throw new IllegalStateException("Nesting problem: " + stack);
  ...
  public CustomJsonWriter inLineValue(String value) throws IOException {
      if (value == null) {
          return nullValue();
      }
      writeDeferredName();
